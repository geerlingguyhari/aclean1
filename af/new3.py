    ...
    <div class="email-container">
        ...
        <div class="content">
            <div class="info-section">
                ...
                <div class="info-line">
                    <div class="info-label">Storage Trend:</div>
                    <div class="info-value">
                        <span class="{{ 'increase-positive' if '↑' in folder_data['increase'] else 'increase-negative' if '↓' in folder_data['increase'] else '' }}">
            ...
            <div class="cleanup-notice">
                ...
                <br><br>
                Found {len(old_images)} images older than {CLEANUP_DAYS} days (see attached CSV for details)
            </div>

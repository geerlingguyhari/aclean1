...
def send_email_report(csv_file, folder_choice, report_scope):
    ...
    try:
        ...
        # Only include cleanup message for filtered reports (not "All Folders")
...
<body>
    <div class="email-container">
        ...
        <!-- Conditionally include cleanup message -->
        {cleanup_html}
        ...
        if report_scope == "All Folders":
            msg['Subject'] = "Artifactory Storage Report - " + datetime.now().strftime('%b %d, %Y')
        else:

    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            if old_images and include_attachments:
                ...
                old_images_sorted = sorted(old_images, key=lambda x: x['created'])
            ...
            if include_attachments:
                ...
                try:
                    with open(output_file, 'r') as f:
                        ...
                        folder_rows = [row for row in reader if row['Main Folder'].strip() == folder_data['folder']]
                        
                        # Sort by Created date (oldest first)
                        folder_rows_sorted = sorted(folder_rows, key=lambda x: x['Created'])
                        
                        # Prepare CSV data with MB size
                        output_csv_data.append(["Repository", "Main Folder", "Image Path", "Created", "Last Used", "Size (MB)"])
                        for row in folder_rows_sorted:

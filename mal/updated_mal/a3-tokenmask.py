...
def fetch_tia_emails_from_api():
    ...
    token = masked_input("Enter API token (masked): ")
...
def process_clusters(clusters_file, output_csv, username, password):
...
def main():
    ...
    process_clusters(clusters_file, output_csv, username, password)

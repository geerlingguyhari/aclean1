...
DEBUG_FILE = f"{OUTPUT_DIR}/debug_mismatches.log"
...
# Aggressive normalization: remove ALL whitespace & control chars (0x00-0x20)
        ...
        for key, encoded_value in data.items():
            ...
            try:
                ...
                if service_id.lower() in decoded_text.lower():
                    ...
                    # Always print both for diagnostics
                    if DEBUG:
                    ...
                    if normalized_provided_bytes == normalized_secret_bytes:
                        ...
                        password_match = "No"
                        # Write to debug file for post-run analysis
